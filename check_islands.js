...
// Extract Islands district institutions using regex
const islandsMatch = appJsContent.match(/"district": "Islands"[\s\S]*?},/g);

if (islandsMatch) {
    console.log(`Found ${islandsMatch.length} Islands district institutions:\n`);
    
    islandsMatch.forEach((match, index) => {
        // Extract name_en
    ...
    console.log('No Islands district institutions found in app.js');
} 