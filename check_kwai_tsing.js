...
// Extract Kwai Tsing district institutions using regex
const kwaiTsingMatch = appJsContent.match(/"district": "Kwai Tsing"[\s\S]*?},/g);

if (kwaiTsingMatch) {
    console.log(`Found ${kwaiTsingMatch.length} Kwai Tsing district institutions:\n`);
    
    kwaiTsingMatch.forEach((match, index) => {
        // Extract name_en
    ...
    console.log('No Kwai Tsing district institutions found in app.js');
} 