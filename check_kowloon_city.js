...
// Extract Kowloon City district institutions using regex
const kowloonCityMatch = appJsContent.match(/"district": "Kowloon City"[\s\S]*?},/g);

if (kowloonCityMatch) {
    console.log(`Found ${kowloonCityMatch.length} Kowloon City district institutions:\n`);
    
    kowloonCityMatch.forEach((match, index) => {
        // Extract name_en
    ...
    console.log('No Kowloon City district institutions found in app.js');
} 