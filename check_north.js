...
// Extract North district institutions using regex
const northMatch = appJsContent.match(/"district": "North"[\s\S]*?},/g);

if (northMatch) {
    console.log(`Found ${northMatch.length} North district institutions:\n`);
    
    northMatch.forEach((match, index) => {
        // Extract name_en
    ...
    console.log('No North district institutions found in app.js');
}